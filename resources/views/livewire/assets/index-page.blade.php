                    ...
                    <div x-data="{ open: true }">
                        ...
                        <div x-show="open" class="mt-4 space-y-2">
                            @foreach($departments as $department)
                                <label class="flex items-center">
                                    <input type="checkbox" wire:model="selectedDepartments" value="{{ $department->id }}"
                                           class="rounded border-gray-300 text-emerald-600 focus:ring-emerald-500">
                    ...
                    <div x-data="{ open: true }">
                        ...
                        <div x-show="open" class="mt-4 space-y-2">
                            @foreach($statusOptions as $status)
                                <label class="flex items-center">
                                    <input type="checkbox" wire:model="selectedStatuses" value="{{ $status }}"
                                           class="rounded border-gray-300 text-emerald-600 focus:ring-emerald-500">
                    ...
                    <div x-data="{ open: true }">
                        ...
                        <div x-show="open" class="mt-4 space-y-2">
                            @foreach($conditionOptions as $condition)
                                <label class="flex items-center">
                                    <input type="checkbox" wire:model="selectedConditions" value="{{ $condition }}"
                                           class="rounded border-gray-300 text-emerald-600 focus:ring-emerald-500">
