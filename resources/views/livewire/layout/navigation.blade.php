...
<nav x-data="{ open: false, profileOpen: false }"
                    ...
                    @if(auth()->user()->hasAdminAccess())
                        ...
                        <div class="relative inline-flex items-center" x-data="{ open: false }">
                            ...
                            <div x-show="open"
                                ...
                                <a href="{{ route('maintenance.index') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Maintenance</a>
                                @if(auth()->user()->isSuperAdmin())
                                    <a href="{{ route('bulk-import.index') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Bulk Import</a>
                                @endif
                            </div>
                        </div>
            ...
            <div class="hidden lg:flex lg:items-center lg:space-x-3">
                ...
                <div class="relative" x-data="{ open: false }">
                    ...
                    <div x-show="open"
                        ...
                        @if(auth()->user()->hasAdminAccess())
                            <x-dropdown-link :href="route('settings.index')" class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                                <svg class="mr-3 h-4 w-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div :class="{'block': open, 'hidden': !open}" class="lg:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if(auth()->user()->hasAdminAccess())
                ...
                <div x-data="{ open: false }" class="relative">
                    ...
                    <div x-show="open" class="px-4 py-2 space-y-1">
                        <a href="{{ route('assets.index') }}" class="block px-3 py-2 text-base font-medium text-gray-600 hover:text-gray-800 hover:bg-gray-50 rounded-md">View All Assets</a>
                        <a href="{{ route('assets.create') }}" class="block px-3 py-2 text-base font-medium text-gray-600 hover:text-gray-800 hover:bg-gray-50 rounded-md">Add New Asset</a>
                        <a href="{{ route('categories.index') }}" class="block px-3 py-2 text-base font-medium text-gray-600 hover:text-gray-800 hover:bg-gray-50 rounded-md">Categories</a>
                        <a href="{{ route('maintenance.index') }}" class="block px-3 py-2 text-base font-medium text-gray-600 hover:text-gray-800 hover:bg-gray-50 rounded-md">Maintenance</a>
                        @if(auth()->user()->isSuperAdmin())
                            <a href="{{ route('bulk-import.index') }}" class="block px-3 py-2 text-base font-medium text-gray-600 hover:text-gray-800 hover:bg-gray-50 rounded-md">Bulk Import</a>
                        @endif
                    </div>
                </div>
            ...
            @if(auth()->user()->isUser())
                <!-- My Assets -->
                <x-responsive-nav-link :href="route('my-assets')" :active="request()->routeIs('my-assets')" wire:navigate
                                       class="flex items-center px-3 py-2 text-base font-medium">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"/>
                    </svg>
            ...
            @if(auth()->user()->hasAdminAccess() || auth()->user()->isAuditor())
                <!-- Audits -->
                <x-responsive-nav-link :href="route('audits.index')" :active="request()->routeIs('audits.*')" wire:navigate
                                       class="flex items-center px-3 py-2 text-base font-medium">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4"/>
                    </svg>
